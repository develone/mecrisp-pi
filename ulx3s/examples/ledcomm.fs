...
\ -----------------------------------------------------------------------------
\ Connect a clear red high-brightness LED with anode to 0+ and cathode to 1+
\ -----------------------------------------------------------------------------
...
: ledcomm ( -- )
  ledcomm-init
  begin now ledcomm-tick 244 25 * delay ( 244 us @ 25 MHz inclusive algorithm ) again
;
